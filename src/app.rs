...
pub async fn run() -> Result<()> {
    ...
    crate::log_info!("Initializing Forrenty application with integrated DPI bypass engine...");
    if let Err(e) = crate::engine::ensure_engine_running().await {
        crate::log_warn!("Failed to initialize embedded DPI bypass engine: {:#}", e);
    }
